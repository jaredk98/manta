...
using GLclampf   = float;
	...
	#define META(type, name, ...)                            \
		using  n##name##proc = type (GL_API *)(__VA_ARGS__); \
		extern n##name##proc n##name;

	#include "opengl.procedures.hpp"
#else
	// Define OpenGL Macros
	...
	#define nglDrawBuffers glDrawBuffers
#endif


extern bool  opengl_init();
extern bool  opengl_swap();
extern void *opengl_proc( const char *name );
extern bool  opengl_load();
extern void  opengl_update();

extern bool  opengl_ubo_init( const int shader, const char *uniformName, GLuint *location, const void *buffer, const GLsizeiptr size );


extern "C"
{
	GL_EXTERN void           GL_API glBindTexture(GLenum, GLuint);
	GL_EXTERN void           GL_API glBlendFunc(GLenum, GLenum);
	GL_EXTERN void           GL_API glCullFace(GLenum);
	GL_EXTERN void           GL_API glPolygonMode(GLenum,GLenum);
	GL_EXTERN void           GL_API glClear(GLbitfield);
	GL_EXTERN void           GL_API glClearColor(GLclampf, GLclampf, GLclampf, GLclampf);
	GL_EXTERN void           GL_API glClearDepth(GLdouble);
	GL_EXTERN void           GL_API glDepthMask(GLboolean);
	GL_EXTERN void           GL_API glDeleteTextures(GLsizei, const GLuint *);
	GL_EXTERN void           GL_API glDrawElements(GLenum, GLsizei, GLenum, const void *);
	GL_EXTERN void           GL_API glDrawArrays(GLenum, GLint, GLsizei);
	GL_EXTERN void           GL_API glEnable(GLenum);
	GL_EXTERN void           GL_API glScissor(GLint, GLint, GLsizei, GLsizei);
	GL_EXTERN GLboolean      GL_API glIsEnabled(GLenum);
	GL_EXTERN void           GL_API glDisable(GLenum);
	GL_EXTERN void           GL_API glGenTextures(GLsizei, GLuint *);
	...
	#define META(type, name, ...) \
		GL_EXTERN type GL_API name(__VA_ARGS__);
