...
class MemberType : public NS::Referencing<MemberType>
{
public:
    static class MemberType*  alloc();

    class MemberType*         init();
...
public:
    ...
    class MemberType*      memberByName(const NS::String* name);
};
...
// static method: alloc
_MTL_INLINE MTL::MemberType* MTL::MemberType::alloc()
{
    return NS::Object::alloc<MTL::MemberType>(_MTL_PRIVATE_CLS(MTLMemberType));
}

// method: init
_MTL_INLINE MTL::MemberType* MTL::MemberType::init()
{
    return NS::Object::init<MTL::MemberType>();
}

// property: name
_MTL_INLINE NS::String* MTL::MemberType::name() const
{
    return Object::sendMessage<NS::String*>(this, _MTL_PRIVATE_SEL(name));
}

// property: offset
_MTL_INLINE NS::UInteger MTL::MemberType::offset() const
{
    return Object::sendMessage<NS::UInteger>(this, _MTL_PRIVATE_SEL(offset));
}

// property: dataType
_MTL_INLINE MTL::DataType MTL::MemberType::dataType() const
{
    return Object::sendMessage<MTL::DataType>(this, _MTL_PRIVATE_SEL(dataType));
}

// method: structType
_MTL_INLINE MTL::StructType* MTL::MemberType::structType()
{
    return Object::sendMessage<MTL::StructType*>(this, _MTL_PRIVATE_SEL(structType));
}

// method: arrayType
_MTL_INLINE MTL::ArrayType* MTL::MemberType::arrayType()
{
    return Object::sendMessage<MTL::ArrayType*>(this, _MTL_PRIVATE_SEL(arrayType));
}

// method: textureReferenceType
_MTL_INLINE MTL::TextureReferenceType* MTL::MemberType::textureReferenceType()
{
    return Object::sendMessage<MTL::TextureReferenceType*>(this, _MTL_PRIVATE_SEL(textureReferenceType));
}

// method: pointerType
_MTL_INLINE MTL::PointerType* MTL::MemberType::pointerType()
{
    return Object::sendMessage<MTL::PointerType*>(this, _MTL_PRIVATE_SEL(pointerType));
}

// property: argumentIndex
_MTL_INLINE NS::UInteger MTL::MemberType::argumentIndex() const
{
...
// method: memberByName:
_MTL_INLINE MTL::MemberType* MTL::StructType::memberByName(const NS::String* name)
{
    return Object::sendMessage<MTL::MemberType*>(this, _MTL_PRIVATE_SEL(memberByName_), name);
}
