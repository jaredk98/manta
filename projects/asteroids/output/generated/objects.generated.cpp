...
{
	sizeof( iObjects::OBJECT_BASE_t ), sizeof( iObjects::obj_asteroid_t ), sizeof( iObjects::obj_projectile_t ), sizeof( iObjects::obj_rocket_t ), 
};
...
{
	"OBJECT_BASE", "obj_asteroid", "obj_projectile", "obj_rocket", 
};
#endif
...
bool iObjects::init()
{
	OBJECT_CONSTRUCTOR_OFFSET( OBJECT_BASE );
	...
	OBJECT_CONSTRUCTOR_DATA( OBJECT_BASE, iObjects::OBJECT_BASE_t );
...
bool iObjects::free()
{
	if( iObjects::OBJECT_CTOR_MANUAL_BUFFER != nullptr )
	{
		memory_free( iObjects::OBJECT_CTOR_MANUAL_BUFFER );
		iObjects::OBJECT_CTOR_MANUAL_BUFFER = nullptr;
	}

	if( iObjects::OBJECT_CTOR_DEFAULT_BUFFER != nullptr )
	{
		memory_free( iObjects::OBJECT_CTOR_DEFAULT_BUFFER );
		iObjects::OBJECT_CTOR_DEFAULT_BUFFER = nullptr;
	}
...
template <> ObjectHandle<OBJECT_BASE> Object::handle<OBJECT_BASE>( const ObjectContext &context ) const
{
...
void iObjects::OBJECT_BASE_t::event_create()
{
	/* do nothing */
}

void iObjects::OBJECT_BASE_t::event_destroy()
{
	/* do nothing */
}
