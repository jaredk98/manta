...
template <> struct ObjectHandle<OBJECT_BASE>
{
	iObjects::OBJECT_BASE_t *data = nullptr;
	iObjects::OBJECT_BASE_t *operator->() const { Assert( data != nullptr ); return data; }
	explicit operator bool() const { return data != nullptr; }
	ObjectHandle( void *object ) { data = reinterpret_cast<iObjects::OBJECT_BASE_t *>( object ); }
};
...
__INTERNAL_OBJECT_DEFINITION_BEGIN()
class obj_asteroid_t : public OBJECT_BASE_t
{
public:
...
__INTERNAL_OBJECT_DEFINITION_BEGIN()
class obj_projectile_t : public OBJECT_BASE_t
{
public:
...
__INTERNAL_OBJECT_DEFINITION_BEGIN()
class obj_rocket_t : public OBJECT_BASE_t
{
public:
